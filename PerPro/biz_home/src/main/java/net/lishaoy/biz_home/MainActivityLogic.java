...
import net.lishaoy.biz_home.category.CategoryFragment;
import net.lishaoy.biz_home.favorite.FavoriteFragment;
import net.lishaoy.biz_home.home.HomeFragment;
import net.lishaoy.biz_home.profile.ProfileFragment;
import net.lishaoy.biz_home.recommend.RecommendFragment;
